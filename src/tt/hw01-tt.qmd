...
ggplot(data = frog_plot) +
  ...
  panel.grid.major = element_blank(), panel.grid.minor = element_blank()) + 
  labs(
    title = "Australian Frog Tribe Abundances at Different Times of Day", x = "", y = "",
    fill = "Tribe", caption = "Cate Stacy, 9/7/25, TidyTuesday 2023 FrogID Data")
```
